...
import bo.edu.ucb.ingsoft.movies.bl.ShowMovies2;
import bo.edu.ucb.ingsoft.movies.dto.MovieList;
import org.telegram.telegrambots.meta.api.objects.Update;
import java.util.List;

public class ObtenerPeliculas2 extends AbstractProcess {
    public ObtenerPeliculas2() {
...
//    }
    ...
    public AbstractProcess handle(Update update, MoviesLongPollingBot bot) {
        ...
        ShowMovies2 showActors = new ShowMovies2();
