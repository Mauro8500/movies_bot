...
import bo.edu.ucb.ingsoft.movies.bl.ShowMovies4;
import bo.edu.ucb.ingsoft.movies.dto.MovieList;
import org.telegram.telegrambots.meta.api.objects.Update;
import java.util.List;

public class ObtenerPeliculas4 extends AbstractProcess {
    public ObtenerPeliculas4() {
...
//    }
    ...
    public AbstractProcess handle(Update update, MoviesLongPollingBot bot) {
        ...
        ShowMovies4 showActors = new ShowMovies4();
